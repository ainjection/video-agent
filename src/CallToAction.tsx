...
export const callToActionSchema = z.object({
  type: z.enum(['subscribe', 'like', 'follow', 'share', 'custom']).default('subscribe'),
  customText: z.string().optional(),
  style: z.enum(['pill', 'box', 'floating', 'pulse']).default('pill'),
      ...
      <AbsoluteFill>
        <div style={{
          ...
          <div style={{
            ...
            alignItems: 'center',
            gap: 10,
            boxShadow: `0 4px 20px rgba(0,0,0,0.3), 0 0 30px ${primaryColor}40`,
          }}>
